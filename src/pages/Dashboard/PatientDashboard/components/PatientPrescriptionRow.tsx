...
interface PatientPrescriptionPropType {
  prescription: PatientPrescriptionDataType;
}

const PatientPrescription = ({ prescription }: PatientPrescriptionPropType) => {
  ...
  const handleDownload = async () => {
    try {
      ...
      link.href = blobUrl;
      link.download = `${user.name}-prescription.pdf`;
